    ...
    <div className="min-h-screen" style={{ backgroundColor: '#fafbfc' }}>
      ...
      {showEditForm && (
        <div style={{
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '8px', padding: '30px', maxWidth: '560px', width: '100%', margin: 'auto', direction: 'rtl' }}>
      ...
      {showContractForm && (
        <div style={{
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '8px', padding: '30px', maxWidth: '420px', width: '100%', direction: 'rtl' }}>
